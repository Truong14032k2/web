                            ...
                            <?php foreach ($result as $each) : ?>
                                <tr class="text-dark">
                                    ...
                                    <td class="text-primary">
                                        ...
                                        switch ($each['rules']){
                                            case '0':
                                                echo '<span class="text-danger">Tắt</span>';
                                                break;
                                            case '1':
                                                echo '<span class="text-info">Slide</span>';
                                                break; 
                                            case '2':
                                                echo '<span class="text-info">Quảng cáo</span>';
                                                break;  
                                            case '3':
                                                echo '<span class="text-info">Bảo hành</span>';
                                                break;   
                                        }
                                    ?>
                                    </td> <!-- Not active Active slide Active sidebar Active exclusivenes -->
                                    <td>
