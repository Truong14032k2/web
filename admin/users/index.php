                            ...
                            <?php foreach ($result as $each) : ?>
                                <tr class="text-dark">
                                    ...
                                    <?php if($_SESSION['lever'] == 1): ?>
                                        <?php if($each['status'] == 1){ ?>
                                            <td>
                                                <a class="btn btn-danger" href="update_status.php?id=<?php echo $each['id']; ?>&status=0">Tắt</a>
                                            </td>
                                        <?php }else{ ?>
                                            <td>
                                                <a class="btn btn-info" href="update_status.php?id=<?php echo $each['id']; ?>&status=1">Bật</a>
                                            </td>
                                        <?php } ?>
                                    <?php endif ?>
                                </tr>
